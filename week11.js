...
const greeting = document.getElementById('practicum');
...
const helloWorld = document.getElementById('practicum2');

function makeTwo() {
	helloWorld.innerText = 'Привет, Мир!';
}
...
const newHeading = document.querySelector('#practicum3');

function makeThree() {
	newHeading.innerText = "Заголовок изменен!";
}
...
const divChangeColor = document.querySelector('#practicum4');
...
const inputValue = document.getElementById('practicum5');

function makeFive() {
	inputValue.value = 'Новое значение';
}
...
function makeNine() {
	...
	newOption.innerText = "Новый вариант";
